...
public class Case1Tests extends BaseTest {
    ...
    void testCase1() {
        ...
        validateSeatsList(u1AvailableSeats, screen1SeatIds, new ArrayList<>());

        List<String> u1SelectedSeats = new ArrayList<String>();
        Collections.addAll(u1SelectedSeats, screen1SeatIds.get(0),screen1SeatIds.get(2),screen1SeatIds.get(5),screen1SeatIds.get(10));
        final String bookingId = bookingController.createBooking(show, user1, u1SelectedSeats);
